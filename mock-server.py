...
def mock_ai_analysis(body):
    ...
    return {
        ...
        "data": {
            ...
            "probabilities": {"bull": bull, "flat": flat, "bear": bear},
            "risks": [
...
def mock_news_denoise(body):
    ...
    return {
        ...
        "data": {
            ...
            "sentiment": {"bullish": bull, "neutral": neutral, "bearish": bear},
            "facts": facts,
...
def mock_stress_lab(body):
    ...
    return {
        ...
        "data": {
            ...
            "scenarios": {
                "2008": {
                    "drawdown": 35 + hash_int(seed + "2008", 10),
                    "remaining": round(
                        amount * (1 - (0.35 + hash_int(seed + "2008", 10) / 100)), 2
                    ),
                    "recoveryYears": 4 + hash_int(seed + "2008", 3),
                },
                "2020": {
                    "drawdown": 22 + hash_int(seed + "2020", 8),
                    "remaining": round(
                        amount * (1 - (0.22 + hash_int(seed + "2020", 8) / 100)), 2
                    ),
                    "recoveryYears": 2 + hash_int(seed + "2020", 3),
                },
                "2022": {
                    "drawdown": 18 + hash_int(seed + "2022", 7),
                    "remaining": round(
                        amount * (1 - (0.18 + hash_int(seed + "2022", 7) / 100)), 2
                    ),
                    "recoveryYears": 3 + hash_int(seed + "2022", 3),
                },
            },
            "psych": {
